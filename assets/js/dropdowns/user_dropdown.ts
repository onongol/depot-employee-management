...
document.addEventListener('DOMContentLoaded', () => {
  const user: DropdownPair = { btn: getEl<HTMLButtonElement>('user-dropdown-btn'), menu: getEl('user-dropdown-menu') };
  const lang: DropdownPair = { btn: getEl<HTMLButtonElement>('language-dropdown-btn'), menu: getEl('language-dropdown-menu') };
  const theme: DropdownPair = { btn: getEl<HTMLButtonElement>('theme-dropdown-btn'), menu: getEl('theme-dropdown-menu') };
