...
from .views.materials import materials_list, export_materials_excel
...
urlpatterns = [
    ...
    # Materials URL
    path('material/', materials_list, name="materials_list"),
    path('export_material_excel/', export_materials_excel, name="export_materials_excel"),
]
