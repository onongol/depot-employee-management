from employee.views.daily_work.daily_work_create.calculation.calculate_amount_price import (
    calculate_amount_price,
)
from employee.views.daily_work.daily_work_create.calculation.calculate_percentages import (
...
def piecework_calculate_records(
    ...
    employee_percentages = calculate_percentages(employees_salary)
    ...
    for emp in employees_salary:
        ...
        for work_id in selected_work_ids:
            ...
            amount_price = calculate_amount_price(
