...
def validate_required(selected_employee_ids, selected_work_ids, work_date, type_work, amounts, works_dict):
    ...
    if missing_amounts:
        missing_work_names = [works_dict[wid].work_name for wid in missing_amounts if wid in works_dict]
        errors.append(
