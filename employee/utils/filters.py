...
def filter_pieceworks(queryset, employee_id=None, employee_name=None, job_title=None, work_name=None, type_work=None, wagon_number=None, type_wagon=None, type_material=None, work_date=None, record_date=None):
