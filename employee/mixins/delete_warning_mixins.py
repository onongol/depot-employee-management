...
from .delete_attention import send_delete_warning
...
class DeleteProtectionMixin:
    """Mixin to check for delete warnings before allowing deletion."""
    def post(self, request, *args, **kwargs):
        self.object = self.get_object()
        ...
        if related_objects and related_objects.exists():
            messages.error(request, self.get_block_message())
